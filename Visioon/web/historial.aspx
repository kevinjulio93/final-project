<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/web/historial.aspx.cs" Inherits="Visioon.web.historial" %>
        ...
        <nav id="menu">
			<ul>
				...
				<li><asp:LinkButton ID="linkMisreservas" runat="server" 
                        onclick="linkMisreservas_Click">Historial</asp:LinkButton></li>
